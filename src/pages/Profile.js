...
const subscribe = async() => {
  const key = "BJpISNHqUdRPr5tivhrZzo_peGtXt0Q6e3YAuL6uBUrW7S_SvM5lSvWOYS6Vo6oL0GPBDJzMm4pYm10KDfP7eDg"
      ...
      <div className="container mx-auto min-h-screen">
        <div className="flex flex-col items-center justify-center">
          <div className="w-full md:w-4/12 text-center">
            ...
            >
              <img
                src="./images/content/my-profile1.jpg"
                alt="my-profile"
                className="object-cover w-full h-full"
              />
            </div>
            <h2 className="text-xl font-semibold mb-1">Rizki Nugroho</h2>
            <p className="text-lg mb-12">Android and Fullstack Developer</p>
          </div>
        </div>
